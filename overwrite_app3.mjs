...
const IMAGES = {
  hero: "https://images.unsplash.com/photo-1593702288056-dcbf1460c9f1?q=80&w=2500&auto=format&fit=crop",
...
// Premium Preloader matches previous styling exactly
...
export default function App() {
  ...
  // Parallax calculations using default useScroll instead of containerRef to avoid hydration issues
  ...
  // Service hover state for background
    ...
    <>
      ...
      <div className="bg-[#0c0c0c] text-[#F5F2EB] min-h-screen selection:bg-[#A69B8D] selection:text-[#0c0c0c] flex flex-col font-sans overflow-x-hidden">
        ...
        <section className="relative w-full h-[100svh] overflow-hidden flex items-center justify-center bg-black">
          {/* Animated masked image reveal */}
          <motion.div 
            initial={{ clipPath: 'polygon(20% 40%, 80% 40%, 80% 60%, 20% 60%)', opacity: 0 }}
            animate={{ clipPath: loading ? 'polygon(20% 40%, 80% 40%, 80% 60%, 20% 60%)' : 'polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)', opacity: 1 }}
            transition={{ duration: 2, delay: 2.8, ease: [0.76, 0, 0.24, 1] }}
            className="absolute inset-0 w-full h-full pointer-events-none z-0"
          >
            <motion.div style={{ y: heroY, scale: heroScale }} className="w-full h-[120%] origin-top">
              <img 
                src={IMAGES.hero} 
            ...
            {/* Vignette */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_30%,#0c0c0c_120%)]" />
          </motion.div>

          <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12 flex flex-col items-center pt-20">
             <div className="flex flex-col items-center text-center">
                <div className="font-serif text-[clamp(4.5rem,15vw,16rem)] leading-[0.8] tracking-tighter flex flex-wrap justify-center overflow-hidden mix-blend-screen text-white">
                  <TextReveal text="SARTORIAL" />
                </div>
                <div className="font-serif text-[clamp(4rem,14vw,15rem)] leading-[0.8] tracking-tighter flex flex-wrap justify-center italic text-[#A69B8D] overflow-hidden">
                  <TextReveal text="Grooming." />
                </div>
             </div>
             ...
             <motion.div 
               ...
               className="mt-16 md:mt-24 text-center pb-24"
             >
                <MagneticButton className="group flex items-center justify-center gap-4 border border-[#A69B8D]/50 w-32 h-32 md:w-40 md:h-40 rounded-full hover:bg-[#A69B8D] hover:text-[#0c0c0c] transition-colors duration-500 overflow-hidden relative">
          ...
          <motion.div 
            ...
            className="absolute bottom-10 left-6 md:left-12 font-sans text-xs tracking-[0.2em] uppercase text-white/50"
          >
             Scroll to explore <br/>
             <div className="w-[1px] h-12 bg-white/20 mt-4 mx-auto md:ml-6 overflow-hidden">
                <motion.div 
                  animate={{ y: [0, 48] }} 
        ...
        <section className="py-12 bg-[#0c0c0c] border-b border-white/5 overflow-hidden flex relative z-20">
          <motion.div 
            ...
            className="flex whitespace-nowrap items-center font-sans text-[11px] uppercase tracking-[0.3em] text-[#A69B8D] px-4"
          >
            {[...Array(6)].map((_, i) => (
        ...
        {/* 3. Sticky Ethos + Video Moment */}
        <section className="relative py-24 md:py-48 px-6 md:px-12 max-w-[1600px] mx-auto w-full z-20">
           <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-32 w-full">
              {/* Left text column sticky */}
              <div className="w-full lg:w-1/2 flex flex-col lg:sticky lg:top-48 z-10 self-start">
                 ...
                 <h2 className="font-serif text-[clamp(2.5rem,5vw,5rem)] font-light text-[#F5F2EB] leading-[1.1] mb-12 lg:mb-16">
                   Reject the rush of the modern world. Embrace <span className="italic text-[#A69B8D]">the ritual.</span>
                 </h2>

                 <div className="font-sans text-lg md:text-xl text-white/50 leading-relaxed font-light flex flex-col gap-8 max-w-xl">
              ...
              {/* Right Images Cinematic */}
              <div className="w-full lg:w-1/2 flex flex-col gap-12 mt-16 lg:mt-32">
                 <motion.div 
                   initial={{ opacity: 0, scale: 0.95 }}
                   whileInView={{ opacity: 1, scale: 1 }}
                   viewport={{ once: true, margin: "-100px" }}
                   transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1] }}
                   className="relative overflow-hidden aspect-[4/5] rounded-sm group cursor-pointer"
                   data-cursor-hover="true"
                 ...
                 <motion.div 
                   ...
                   viewport={{ once: true, margin: "-100px" }}
                   transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
                   className="lg:-ml-32 mt-12 w-[80%] aspect-[4/3] overflow-hidden rounded-sm relative shadow-2xl z-10"
                 >
                    <img src={IMAGES.chair} alt="Tools" className="w-full h-full object-cover grayscale opacity-70" />
                 </motion.div>
              </div>
           </div>
        </section>
        ...
        <section ref={targetRef} className="relative h-[300vh] bg-[#050505]">
          <div className="sticky top-0 h-screen flex items-center overflow-hidden">
             ...
             <motion.div style={{ x }} className="flex gap-8 md:gap-20 px-6 md:px-24 h-[60vh] md:h-[70vh] items-center text-[#F5F2EB] whitespace-nowrap">
                ...
                {/* Intro massive text block inside horizontal scroll */}
        ...
        {/* 6. Artifacts / Shop Preview (New Section) */}
        <section className="py-32 md:py-48 px-6 md:px-12 max-w-[1600px] mx-auto w-full text-center flex flex-col items-center">
              ...
              <a href="#" className="group flex flex-col items-center text-left" data-cursor-hover="true">
                 ...
                 <div className="w-full flex justify-between items-center px-4">
                    <div>
                      ...
                      <p className="font-sans text-xs uppercase tracking-widest text-white/40">Sandalwood & Vetiver</p>
                    </div>
              ...
              <a href="#" className="group flex flex-col items-center text-left" data-cursor-hover="true">
                 ...
                 <div className="w-full flex justify-between items-center px-4">
                    <div>
                      ...
                      <p className="font-sans text-xs uppercase tracking-widest text-white/40">Strong Hold</p>
                    </div>
           ...
           <MagneticButton className="mt-24 border-b border-[#A69B8D] pb-2 font-sans text-xs uppercase tracking-[0.2em] hover:text-[#A69B8D] transition-colors">
              Explore The Shop
           </MagneticButton>
        </section>
